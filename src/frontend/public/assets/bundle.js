...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EditForm = __webpack_require__(165);
	
	var _EditForm2 = _interopRequireDefault(_EditForm);
	
	var _ExpensesList = __webpack_require__(168);
	
	var _ExpensesList2 = _interopRequireDefault(_ExpensesList);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'app' },
	                _react2.default.createElement(_ExpensesList2.default, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ExpensesItem = __webpack_require__(172);
	
	var _ExpensesItem2 = _interopRequireDefault(_ExpensesItem);
	...
	var ExpensesList = (function (_Component) {
	    _inherits(ExpensesList, _Component);
	
	    function ExpensesList(props) {
	        _classCallCheck(this, ExpensesList);
	
	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(ExpensesList).call(this, props));
	    ...
	    _createClass(ExpensesList, [{
	        ...
	        value: function fetchExpenses() {
	            var _this = this;
	            _superagent2.default.get('http://localhost:5000/expensesList').end(function (err, res) {
	                if (err) {
	                    console.log(err);
	                }
	        ...
	        key: 'deleteExpense',
	        value: function deleteExpense(timestamp) {
	            var _this = this;
	            _superagent2.default.post('http://localhost:5000/deleteExpense').send({ date: timestamp }).set('Content-type', 'application/json; charset=UTF-8').set('Access-Control-Allow-Origin', '*').end(function (err, res) {
	                if (err) {
	                    console.log(err);
	                }
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    { className: 'expensesItemList' },
	                    expenses.map(function (item) {
	                        return _react2.default.createElement(_ExpensesItem2.default, { name: item.name, amount: item.amount, date: item.date, deleteCB: _this.deleteExpense });
	                    })
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExpensesItem = (function (_Component) {
	    _inherits(ExpensesItem, _Component);
	
	    function ExpensesItem(props) {
	        _classCallCheck(this, ExpensesItem);
	
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ExpensesItem).call(this, props));
	
	        _this.onDelete.bind(_this);
	        return _this;
	    }
	
	    _createClass(ExpensesItem, [{
	        key: 'onDelete',
	        value: function onDelete() {
	            console.log("delete");
	            this.props.deleteCB(this.props.date);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	...
	exports.default = ExpensesItem;
	
	ExpensesItem.propTypes = {
	    name: _react2.default.PropTypes.string.isRequired,
	    amount: _react2.default.PropTypes.number.isRequired,
	    date: _react2.default.PropTypes.number.isRequired,
	    deleteCB: _react2.default.PropTypes.func.isRequired
	};
